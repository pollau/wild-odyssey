export const ui = {
  fr: {
    ...
    "notFound.body": "Le lien est peut-être erroné, ou la page a été déplacée depuis votre dernière visite.",
    "notFound.cta": "Retour à l'accueil",
    "notFound.seoTitle": "Page introuvable",
    "notFound.seoDescription": "Cette page n'existe pas ou n'existe plus.",
  ...
  en: {
    ...
    "notFound.body": "The link may be wrong, or the page may have moved since your last visit.",
    "notFound.cta": "Back to the homepage",
    "notFound.seoTitle": "Page not found",
    "notFound.seoDescription": "This page does not exist, or no longer does.",
  ...
  es: {
    ...
    "notFound.body": "Puede que el enlace sea incorrecto, o que la página se haya movido desde tu última visita.",
    "notFound.cta": "Volver al inicio",
    "notFound.seoTitle": "Página no encontrada",
    "notFound.seoDescription": "Esta página no existe, o ha dejado de existir.",
