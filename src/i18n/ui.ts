export const ui = {
  ...
  en: {
    ...
    "contact.successBody": "Message received, we're passing it on to the crew! We'll get back to you soon to set the course :)",
  ...
  es: {
    ...
    "contact.successBody": "¡Mensaje recibido, se lo pasamos a la tripulación! Volvemos pronto para marcar el rumbo :)",
