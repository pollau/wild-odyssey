        ...
        statsSection: singleton({
            ...
            schema: {
                fr: fields.object({
                    ...
                    badgeScience: fields.text({ label: 'Pastille', description: "Apparait a deux endroits : en cyan sur la bande des chiffres, en blanc au-dessus des 6 bonnes raisons." }),
